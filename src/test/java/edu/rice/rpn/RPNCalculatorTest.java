...
public class RPNCalculatorTest {
  ...
  public void testScan() throws Exception {
    IList<NamedMatcher.Token<RPNCalculator.RPNTokenPatterns>> scan1 = RPNCalculator.scan("1 2 + 3 *");
    IList<NamedMatcher.Token<RPNCalculator.RPNTokenPatterns>> expectedResult1 = List.of(
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.NUMBER, "1"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.NUMBER, "2"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.PLUS, "+"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.NUMBER, "3"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.TIMES, "*"));

    assertEquals(expectedResult1, scan1);

    IList<NamedMatcher.Token<RPNCalculator.RPNTokenPatterns>> scan2 = RPNCalculator.scan("1 2 + 3 yuck");
    IList<NamedMatcher.Token<RPNCalculator.RPNTokenPatterns>> expectedResult2 = List.of(
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.NUMBER, "1"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.NUMBER, "2"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.PLUS, "+"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.NUMBER, "3"),
        new NamedMatcher.Token<>(RPNCalculator.RPNTokenPatterns.FAIL, ""));
