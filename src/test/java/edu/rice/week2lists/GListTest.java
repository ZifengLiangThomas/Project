...
public class GListTest {
  ...
  public void testEmptyHead() throws Exception {
    ...
    String noHead = emptyList.head(); // we're expecting this to throw an exception, noted in the @Test above
  ...
  public void testFoldlRollingAccAvg() throws Exception {
    ...
    assertEquals(3.0, numbers.foldl(numbers.empty() ? 0.0 : numbers.head(), (x,y) -> (x + y) / 2), 0.0);
  }
}