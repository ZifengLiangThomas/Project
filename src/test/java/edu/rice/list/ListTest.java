...
import static edu.rice.list.IList.isSorted;
...
public class  ListTest {
  ...
  public void testHead() throws Exception {
    ...
    emptyList.head(); // should throw an exception, which we're expecting (see the @Test above)
  ...
  public void testOFlatMap() throws Exception {
    ...
    final IList<String> result =
        list1.oflatmap(name ->
            (name.length() > 0 && Character.isUpperCase(name.charAt(0))) // if the first character is uppercase
  ...
  public void testSort() throws Exception {
    ...
    assertFalse(isSorted(numbersBackwards));
    assertTrue(isSorted(numbersInOrder));
  }
}